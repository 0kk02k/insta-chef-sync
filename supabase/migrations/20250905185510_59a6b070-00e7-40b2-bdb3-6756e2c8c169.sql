-- Add new columns to profiles table for user preferences (skip display_name as it exists)
ALTER TABLE public.profiles 
ADD COLUMN language TEXT DEFAULT 'de',
ADD COLUMN measurement_unit TEXT DEFAULT 'metric';

-- Update the handle_new_user function to include user preferences from metadata
