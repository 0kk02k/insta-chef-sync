            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-4 flex-1">
                <Slider
                  ...
                  step={1}
                  className="flex-1 [&_[role=slider]]:border-[#ae83e6] [&_[role=slider]]:bg-white [&_[role=slider]]:ring-4 [&_[role=slider]]:ring-[#ae83e6] [&_[role=slider]]:ring-offset-0 [&_[role=slider]]:focus-visible:ring-4 [&_[role=slider]]:outline-none [&_[role=slider]]:focus-visible:outline-none [&>span>span]:bg-[#ae83e6] [&>span]:bg-[hsl(21,100%,81%)]"
                />
                <Input
                  id="portions"
                  type="number"
